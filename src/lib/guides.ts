...
const english: GuideCard[] = [
  ...
  { slug: "puzzle-solutions", number: "02", title: "Puzzle Solutions", description: "Use safe puzzle methods, researched clues, and clear {to be confirmed} boundaries for room answers.", status: "published" },
  { slug: "bosses", number: "03", title: "Boss Guide", description: "Review confirmed combat framing, Tower Top research, and unverified boss details marked {to be confirmed}.", status: "published" },
  ...
  { slug: "secrets", number: "06", title: "Secrets", description: "Find research-backed hidden-route methods and revisit advice while exact locations remain {to be confirmed}.", status: "published" },
  ...
  { slug: "price", number: "10", title: "Price", description: "Use the official Steam purchase route while current currency, discounts, and regional values stay {to be confirmed}.", status: "published" },
  { slug: "demo", number: "11", title: "Demo", description: "Check the official release context and keep demo availability clearly marked {to be confirmed}.", status: "published" },
  ...
  { slug: "game-length", number: "18", title: "Game Length", description: "Understand the single-player format and time factors while measured estimates remain {to be confirmed}.", status: "published" },
];
